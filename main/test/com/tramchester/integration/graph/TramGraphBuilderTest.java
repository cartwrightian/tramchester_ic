...
//        assertEquals(-1, minuteNodeIds.size());
    ...
    void shouldHaveSameOutboundTripIdsForNeighbouringRouteStationWhenSameRouteAndSvc() {
        ...
        ImmutableEnumSet<TransportRelationshipTypes> relationshipTypes = ImmutableEnumSetImpl.of(TO_SERVICE);
...
//            assertTrue(fromA || fromB, serviceRepository.getServiceById(svcId).toString());
    ...
    void shouldHaveCorrectRelationshipsAtCornbrook() {
        ...
        List<GraphRelationship> outboundsA = getRouteStationRelationships(routeStationCornbrookAltyPiccRoute, Outgoing, transportRelationshipTypes);
    ...
    void shouldSaneNumberOfRelationships() {
        ...
        ImmutableEnumSet<TransportRelationshipTypes> allRelTypes = ImmutableEnumSetImpl.allOf(TransportRelationshipTypes.class);
    ...
    private void checkOutboundConsistency(Station station, Route route) {
        ...
        List<GraphRelationship> routeStationOutbounds = getRouteStationRelationships(routeStation, Outgoing,
                ImmutableEnumSetImpl.allOf(TransportRelationshipTypes.class));
