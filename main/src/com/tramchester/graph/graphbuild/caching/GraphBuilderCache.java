...
public class GraphBuilderCache implements RouteStationNodeCache, StationAndPlatformNodeCache {
    ...
    @Override
    public MutableGraphNodeNeo4J getRouteStation(MutableGraphTransaction txn, Route route, IdFor<Station> stationId) {
    ...
    public MutableGraphNodeNeo4J getRouteStation(MutableGraphTransaction txn, IdFor<RouteStation> id) {
    ...
    @Override
    public MutableGraphNodeNeo4J getStation(MutableGraphTransaction txn, IdFor<Station> stationId) {
    ...
    @Override
    public MutableGraphNodeNeo4J getPlatform(MutableGraphTransaction txn, IdFor<Platform> platformId) {
