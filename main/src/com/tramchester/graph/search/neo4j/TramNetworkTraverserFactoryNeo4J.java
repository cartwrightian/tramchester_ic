...
public class TramNetworkTraverserFactoryNeo4J implements TramNetworkTraverserFactory {
    ...
    public TramNetworkTraverserFactoryNeo4J(TramchesterConfig config, boolean fullLogging, BranchOrderingPolicy orderingPolicy,
    ...
    public TramNetworkTraverser get(final GraphTransaction txn) {
        return new TramNetworkTraverserNeo4J(txn, config, fullLogging, orderingPolicy, destinations, destinationNodeIds);
    }
}
