...
public class FindStateAfterRouteStation  {
    ...
    public TraversalState endTripTowardsPlatform(final TraversalStateType towardsState, final RouteStationStateEndTrip routeStationState,
        ...
        final Stream<GraphRelationship> platformRelationships = getBoardsAndOthers(node, txn, true);
    ...
    public TraversalState onTripTowardsStation(final TraversalStateType destination, final RouteStationStateOnTrip onTrip, final GraphNode node,
        ...
        final Stream<GraphRelationship> relationships = getBoardsAndOthers(node, txn, false);
        final Stream<GraphRelationship> filteredRelationships = stateBuilder.filterExcludingNode(txn, relationships, onTrip);
    ...
    private Stream<GraphRelationship> getBoardsAndOthers(final GraphNode node, final GraphTransaction txn, final boolean isPlatform) {

        final Stream<GraphRelationship> other;
        if (isPlatform) {
