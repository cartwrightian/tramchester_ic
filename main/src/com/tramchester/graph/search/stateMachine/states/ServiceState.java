...
public class ServiceState extends TraversalState {
    ...
    private ServiceState(TraversalState parent, Stream<GraphRelationship> relationships, ExistingTrip maybeExistingTrip,
    ...
    private ServiceState(TraversalState parent, Stream<GraphRelationship> relationships, Duration cost, Towards<ServiceState> builder) {
        super(parent, relationships, cost, builder.getDestination());
