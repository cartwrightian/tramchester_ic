...
public class RouteCalculatorArriveBy implements TramRouteCalculator {
    ...
    @Override
    public Stream<Journey> calculateRoute(MutableGraphTransaction txn, Location<?> startStation, Location<?> destination, JourneyRequest journeyRequest) {
        try {
    ...
    @Override
    public Stream<Journey> calculateRouteWalkAtEnd(MutableGraphTransaction txn, Location<?> start, GraphNode endOfWalk, LocationSet  destStations,
    ...
    @Override
    public Stream<Journey> calculateRouteWalkAtStart(MutableGraphTransaction txn, Set<StationWalk> stationWalks, GraphNode origin, Location<?> destination,
                                                     JourneyRequest journeyRequest, NumberOfChanges numberOfChanges) {
        try {
    ...
    @Override
    public Stream<Journey> calculateRouteWalkAtStartAndEnd(MutableGraphTransaction txn, Set<StationWalk> stationWalks, GraphNode startNode,
