...
public class GraphNodeIdNeo4J implements GraphNodeId {
    ...
    private final ImmutableEnumSet<GraphLabel> labels;
    private final int hashCode;

    // NOTE: labels not provided unless DB diagnostics set to true

    GraphNodeIdNeo4J(final String internalId, final ImmutableEnumSet<GraphLabel> labels) {
    ...
    public static GraphNodeIdNeo4J TestOnly(final long l) {
        return new GraphNodeIdNeo4J(Long.toString(l), ImmutableEnumSet.noneOf(GraphLabel.class));
    }
